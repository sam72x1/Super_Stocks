...
# ⏳ سقف انتظار الجرس قبل الافتتاح (إصلاح 2026-07-28). كان 90 دقيقة، وهو **يكفي صيفًا
# ولا يكفي شتاءً**: بعد تقديم الكرون لتعويض تأخّر GitHub المرصود (95-152 دقيقة، وسيط
# ~119 على 11 يومًا) يبدأ الجوب في أبكر الحالات ~12:46 UTC، والافتتاح الشتوي 14:30 ⇒
# فجوة 104 دقائق كانت تتجاوز الـ90 فيمسح الرادار **قبل الجرس** (تغيير سلوك غير مقصود).
