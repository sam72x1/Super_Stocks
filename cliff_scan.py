...
def selftest():
    ...
    VERDICT_PATH = {
        ...
        "split_radar_ready": "7002dda81b304609",
        # 🔴 **إقرارٌ ثالث (2026-08-06):** نُقل خطّافُ ترتيب T-CLIFF-2 إلى **هذي**
        #    الدالّة بعد أن أثبتت العدّاداتُ أن وضعَه في `scan_split_radar` جعل ذراعَ
        #    الترتيب **no-op** (‏145/150 في الحالتين). الافتراضُ `"cliff"` = السلوكُ
        #    السابق حرفيًّا، والخطّافُ في **مُرشّح التكلفة** لا في الشروط الخمسة.
        "scan_split_hunter": "6a2c16b792fa418f"}
