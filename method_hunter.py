...
**الشروطُ السبعة** (‏`scan_method_hunter`): حدثٌ مؤسِّس (صعودٌ عالٍ ثم هبوط **10-30**
جلسة — «من 10 ايام لشهر»، منشور 2026-08-15) · التسلسل الرباعيّ · هدفٌ بنيويّ (رأس شمعة الفجوة) · خالٍ من قروب · لا
إعلان طرح · وسياق الاقتراض · **و`RSI` تحت 30** («+ RSI تحت 30»، منشور 2026-08-15).
