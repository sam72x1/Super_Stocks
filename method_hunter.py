...
**الشروطُ الستّة** (‏`scan_method_hunter`): حدثٌ مؤسِّس (صعودٌ عالٍ ثم هبوط **20-30**
جلسة — `IMG_0489`) · التسلسل الرباعيّ · هدفٌ بنيويّ (رأس شمعة الفجوة) · خالٍ من
قروب · لا إعلان طرح · وسياق الاقتراض.
🔴 **ونصٌّ أحدث (منشور 2026-08-15) قِيس ونُفِّذ ثم أُلغي في اليوم نفسه بأمر
المالك** («ارجع 20» · «الغ شرط rsi»): نافذةُ **‏10-30** و**`RSI` تحت 30** بوّابةً.
القياسُ محفوظ (`method_window_result.md`: التوسيعُ 196 ⟶ 364 · وشرطُ `RSI` يقصّ
**‏89.8%** ويُخرج أسماءَ كاتالوج فيصل نفسِه) ⇒ إعادةُ أيٍّ منهما **سطرٌ واحد**.
و`RSI` **يُطبَع في السجلّ ولا يرفض**.
