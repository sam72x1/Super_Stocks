...
# 🔴✂️ **تنويهُ القصّ — مصدرٌ واحدٌ عند المقياس نفسِه** (بلاغُ المالك على
# `HUIZ` 2026-08-22): كلُّ رقمٍ تُنتجه `resolve` **مقصوصٌ عند الخروج البنيويّ**،
# فسهمٌ يُكسَر قاعُه ثم ينفجر بعد ساعاتٍ يُقرأ «خسر» وهو صعد أضعافًا. الرقمُ
# صحيحٌ لمقياسه **والوسمُ العاري يكذب** ⇒ كلُّ أداةٍ تطبع حصيلةً تطبع هذا
# السطرَ معها. مقيسٌ على جلستَي 08-20/21: ‏12 من 127 (‏9.4%) موسومًا
# «خسرت/معلّقة» قمّةُ يومه ‏+30% فأكثر — التفصيل في `exit_cut_result.md`.
MEASURE_CUT_NOTE = (
    "✂️ **تنويهٌ إلزاميّ:** الأرقامُ مقصوصةٌ عند **الخروج البنيويّ** (أوّلُ "
    "إغلاقِ دقيقةٍ دون قاع شمعة المِرساة) ⇒ «خسرت» تعني **«بقاعدة الخروج»** "
    "لا «السهمُ خسر»؛ وقد تقع قمّةُ اليوم **بعد** الخروج فلا تدخل القياس."
)
