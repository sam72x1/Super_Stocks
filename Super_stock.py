...
CONFIG = {
    ...
    #    ⚠️ **وما لا يقيسه الظرف يبقى برقمنا** (تدقيق 2026-08-07): الصلبة الوحيدة
    #    `RECENT_RISE_BLOCK_PCT`=35 (منع الملاحقة، D11 مقفول «تبقى كما هي») + لينتان
    #    `MA_GATE_MAX_ABOVE_PCT`=15 و`GAP_ABOVE_MAX_DIST_PCT`=60 + `TF_MIN_REVERSALS`
    #    (مُصرَّح به) — تغييرُ أيٍّ منها قرارُ مالكٍ بمعايرةٍ جديدة.
...
LOGIC_VERSION = "2026.08.07-d15cat+proxfirst+faisalonly+faisalsoft+opendoor+m14hard+bluetargets+redheads.dw+noskip+tranches+4h+keylevels+avgRR"
