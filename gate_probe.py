...
def _lock_g0():
    ...
    bars_fl = base + [_b(8, 1.00, 1.30, 1.00, 1.29, 16_000),
                      _b(9, 1.29, 1.30, 1.28, 1.29, 100)]
    # 🔄 **إقراران مؤرَّخان 2026-08-19 (في يومٍ واحد):** اعتمد المالكُ رقمَ
    #    `G5` (‏15K) فانقلب هذا القفلُ إلى تكافؤٍ — **ثم سحبه في اليوم نفسه**
    #    («اسحب عليها») فعاد التفرّقُ حيًّا كما تنبّأ نصُّ التكافؤ («لو عادت
    #    الأرضيةُ فوق رقم G5 عاد التفرّقُ») ⇒ الصيغةُ الأصلية مستعادة.
