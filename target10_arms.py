...
def main() -> int:                                                # noqa: C901
    ...
    if not one_day:
        ...
        if _cov_bad:
            ...
            return 3
    # 🔴 وضعُ اليوم: ملفٌّ غائب (‏404) كان يخرج **أخضرَ بصفر صفوف** = no-op
    #    صامت (وقع فعلًا: تشغيلةُ 2026-08-25 الأولى «نجحت» والملفُّ لم يُنشَر
    #    بعدُ على S3) ⇒ صفرُ أيامٍ مقيسة في وضع اليوم = عطبُ أداةٍ لا نتيجة.
