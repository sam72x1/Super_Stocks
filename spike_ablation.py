...
EDGES_FP = "019c983e1691"   # ⟵ 2c2707cfd0dd (‏P90) — بُدِّل 2026-08-08 بأمر المالك: حدُّ المالك P100   # ⟵ 4fb70bcc13e5 (‏14) ⟵ b4e5372075c1 (‏11)
                            # حُدِّثت 2026-08-07 مساءً: 15 معيارًا (tf_count) بأمر المالك
# 🔴 **وأثرُ التبديل على النتيجة المنشورة يُعلَن لا يُبتلَع:** أرقامُ
#    `spike_ablation_result.md` (‏`w=0.0935` · `drop_pct` الفاعل) حُسبت على
#    الظرف **‏2dc8c7afb0db** المُعايَر بمِرساةٍ ملوَّثة. والظرفُ الآن
#    **‏a454cd33c848** (ستٌّ من إحدى عشرة حافّة **متطابقة** وخمسٌ تحرّكت قليلًا)
#    ⇒ **الأرقامُ مرجَّحُ ثباتِها ولا يُدَّعى أنها ثابتة** حتى تُعاد التشغيلة.
