...
V3_FINGERPRINT = "019c983e1691"   # ⟵ 2c2707cfd0dd (‏P90) — بُدِّل 2026-08-08 بأمر المالك «طبّقها»: حدُّه المنصوص P100   # تعديل ⑬ (… ⟶ b4e53 ⟶ 4fb70 ⟶ هذا: ‏15 معيارًا
                                  # بعد قياس tf_count بأمر المالك «سوها» 2026-08-07)
# 🔴 **تصحيحٌ مع التعديل ⑩ (2026-08-06):** كان الكودُ على `2dc8c7afb0db` و
#    `envelope_prereg.md` يُعلن `bbc3cfde3e92` ⇒ **الحارسُ يحرس رقمًا لا وجود له
#    في الوثيقة، والوثيقةُ تصف رقمًا ليس في الكود.** وُحِّدا الآن على بصمة
#    المعايرة النظيفة (تشغيلة `31070365317` · لقطة `31070013412`).
V3_PCT = 90
V3_N_SYMBOLS = 25                 # تعديل ⑪ (‏30 ⟶ 28 ⟶ هذا: قرارُ المالك «25 فقط»)
V3_EXCLUDED = {"HTZ", "YYAI", "XHLD", "APVO", "CMTL", "KLXE"}   # تعديل ⑪
