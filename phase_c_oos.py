...
if survivors:
    ...
    print("📋 الحكم المسجَّل مسبقًا: لا حافة فرز كبيرة مستقرة من FDR بالسنتين → قرائن لا حواف.")
    print("   ⚠️ تصحيح P0 (تدقيق Codex): «لا شيء ينجو» = «لا حافة كبيرة» لا «لا أثر» (القوة تكشف ~39-44%).")
    print("      المرجع القانوني للأرقام: phase_p0_audit.py + P0_AUDIT_AMENDMENT_2026-07-13.yaml.")
