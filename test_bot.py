...
_px_cfg = {"MIN_PRICE": 1.649999976158142, "MIN_DROP_FLOOR": 89.58801459243173,
           ...
           "WATCH_MAX_FAILS": 7, "NEAR_PCT": 10.0, "SCORE_MIN": 35,
...
check("🥇 SOFT10 بصمةُ الحوافّ النافذة = معايرةُ الخمسة عشر (‏`cf1d0f902d23`)",
      __import__("envelope_scan").edges_fingerprint(
          __import__("envelope_scan").load_edges()) == "cf1d0f902d23")
