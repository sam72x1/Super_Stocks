...
# ── 🔬 P1-2: جدولة إيقاع مطلقة (لا interval+scan) ──
check("🔬 P1-2 قفل: الحلقة تستعمل جدولة مطلقة (_next_tick += interval) لا sleep(interval) فقط",
      "_next_tick += interval" in _insp0.getsource(IG.main))
