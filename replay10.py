...
# 🪑 **‏15 بقرار المالك 2026-08-12** («اعتمد سعة 15») ⇒ يطابق `WATCHLIST_SIZE`
#    الحيّ. 🔴 **وقفلُ `REPLAY10🔒` أمسك التغييرَ فأدّى عملَه:** كان الثابتُ 10
#    والتعليقُ يقول «= الحيّ» فصار كذبًا لحظةَ اعتماد 15 — وهو بعينه صنفُ العيب
#    `P0-02` الذي بُنيت هذي الأداةُ لإصلاحه (باكتيستٌ يقيس 15 والحيُّ 10).
# ⚠️ **وأثرُه على ما نُشر يُعلَن ولا يُطوى:** كلُّ أرقام `replay10_result.md` و
#    `ranker2_result.md` و`slot_result.md` و`ranker_tie_result.md` **مقيسةٌ عند
#    سعة 10** ⇒ لا تُقارَن بتشغيلةٍ جديدة إلّا بتمرير `capacity=10` صراحةً
#    (الوسيطُ موجودٌ في `replay` فإعادةُ إنتاجها ممكنةٌ حرفيًّا).
CAPACITY = 15          # سقف الاختيار (= WATCHLIST_SIZE الحيّ — مقفولٌ)
