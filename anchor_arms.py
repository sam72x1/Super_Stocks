...
# 🥇 إقرارٌ مؤرَّخ (2026-08-14، بعد اعتماد B2 إنتاجيًّا): `A0` صارت **"pivot"**
#    — القيمةُ "" لم تعد الأساسَ القديم (‏`ANCHOR_MODE` الإنتاجيّ يحكمها) ⇒
#    بلا هذا التغيير كانت A0 ستقيس `tested_strict` **وتُسمّيها الأساس** (no-op
#    مقلوب). الأرقامُ المنشورة (‏§⑨-⑫) تُعاد بـ"pivot" حرفيًّا.
ARMS: dict[str, str] = {"A0": "pivot", "B1": "tested", "B2": "tested_strict"}
BASE_ARM = "A0"
